...
E_D("replace into `catalogs` values('3','0','','企业概况','Situation','','1478956580','','100','1','<div class=''txtConList''><p style=\"text-align: center;\"><img src=\"/public/images/zuzhi.jpg\"/></p></div>','','','/public//images/banner_zizhi.png','','','zh','');");
...
E_D("replace into `catalogs` values('11','3','','企业文化','Culture','','','catalogs/arcs','100','2','','','arcs','/public//images/banner_zizhi.png','thumbarcs','','zh','');");
E_D("replace into `catalogs` values('43','42','','代表项目','Project','','','catalogs/arcs','100','0','','','arcs','/public//images/banner_dbxm.jpg','Project','arc','','');");
...
E_D("replace into `catalogs` values('34','3','','组织架构','Organization','','1479298885','catalogs/single','100','0','?<br />\n<p style=\"text-align:center;\">\n	<br />\n<img src=\"/public/images/zuzhi.jpg\" />\n</p>\n<br />','','single','/public//images/banner_zizhi.png','single','','zh','');");
...
E_D("replace into `catalogs` values('38','0','','媒体中心','Media','','','','100','0','','','','/public/images/banner_mtzx.jpg','','','','');");
...
E_D("replace into `catalogs` values('41','40','','招贤纳士','Jobs','','','joinus/arcs','100','0','','','','/public/images/banner_zxns.jpg','joinus','joinus','','');");
E_D("replace into `catalogs` values('42','0','','产品与服务','Product','','','','100','0','','','','/public//images/banner_dbxm.jpg','','','','');");
E_D("replace into `catalogs` values('46','42','','服务模式','Service Mode','','','catalogs/arcs','100','0','','','arcs','/public/images/banner_dbxm.jpg','thumbarcs','','','');");
E_D("replace into `catalogs` values('45','42','','区域市场','Market','','','catalogs/arcs','100','0','','','','/public/images/banner_dbxm.jpg','quyu','','','');");
...
E_D("replace into `catalogs` values('48','38','','企业宣传片','Videos','','','catalogs/arcs','100','0','','','','/public/images/banner_mtzx.jpg','videos','','','');");
E_D("replace into `catalogs` values('49','38','','媒体来访','Visit','','','catalogs/arcs','100','0','','','arcs','/public/images/banner_mtzx.jpg','thumbarcs','','','');");
E_D("replace into `catalogs` values('50','33','','公司资质','Aptitude','','','catalogs/thumbs','100','0','','','','/public//images/banner_zizhi.png','thumbarcs2','','','');");
E_D("replace into `catalogs` values('51','33','','历年荣誉','AllHonor','','','catalogs/thumbs','100','0','','','','/public//images/banner_zizhi.png','thumbarcs2','','','');");
