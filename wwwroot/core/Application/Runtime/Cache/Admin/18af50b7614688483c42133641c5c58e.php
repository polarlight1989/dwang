			...
			<thead>
				...
				<tr role="row" class="filter">
					...
					<td ng-repeat='v in columns' >
						...
						<!-- select -->
						<select ng-if="v.search.type == 'select'" class="form-control form-filter" name="searchparams[equal][{{v.search.field}}]"><option ng-if="v.search.title" value="*">{{v.search.title}}</option><option ng-repeat="(kk,vv) in v.search.data" value="{{kk}}" ng-if="vv">{{vv}}</option></select>
